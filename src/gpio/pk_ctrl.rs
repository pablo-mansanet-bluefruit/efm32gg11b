#[doc = "Reader of register PK_CTRL"]
pub type R = crate::R<u32, super::PK_CTRL>;
#[doc = "Writer for register PK_CTRL"]
pub type W = crate::W<u32, super::PK_CTRL>;
#[doc = "Register PK_CTRL `reset()`'s with value 0x0050_0050"]
impl crate::ResetValue for super::PK_CTRL {
    type Type = u32;
    #[inline(always)]
