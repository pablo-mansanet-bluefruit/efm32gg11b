...
#[doc = "Write proxy for field `CTO0`"]
pub struct CTO0_W<'a> {
    w: &'a mut W,
}
impl<'a> CTO0_W<'a> {
...
#[doc = "Write proxy for field `CTO1`"]
pub struct CTO1_W<'a> {
    w: &'a mut W,
}
impl<'a> CTO1_W<'a> {
...
impl W {
    ...
    #[inline(always)]
    pub fn clear(&mut self) -> CLEAR_W { CLEAR_W { w: self } }
    #[doc = "Bit 3 - Clear Toggle Output 0"]
    #[inline(always)]
    pub fn cto0(&mut self) -> CTO0_W { CTO0_W { w: self } }
    #[doc = "Bit 4 - Clear Toggle Output 1"]
    #[inline(always)]
    pub fn cto1(&mut self) -> CTO1_W { CTO1_W { w: self } }
}
