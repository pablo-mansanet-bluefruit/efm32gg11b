#[doc = "Reader of register POLARITY"]
pub type R = crate::R<u32, super::POLARITY>;
#[doc = "Writer for register POLARITY"]
pub type W = crate::W<u32, super::POLARITY>;
#[doc = "Register POLARITY `reset()`'s with value 0"]
impl crate::ResetValue for super::POLARITY {
    type Type = u32;
    #[inline(always)]
