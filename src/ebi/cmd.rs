...
impl W {
    ...
    #[inline(always)]
    pub fn eccstart(&mut self) -> ECCSTART_W { ECCSTART_W { w: self } }
    #[doc = "Bit 1 - Error Correction Code Generation Stop"]
    #[inline(always)]
    pub fn eccstop(&mut self) -> ECCSTOP_W { ECCSTOP_W { w: self } }
    #[doc = "Bit 2 - Error Correction Code Clear"]
    #[inline(always)]
    pub fn eccclear(&mut self) -> ECCCLEAR_W { ECCCLEAR_W { w: self } }
}
