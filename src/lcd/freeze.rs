...
#[doc = "Reader of field `LCDGATE`"]
pub type LCDGATE_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `LCDGATE`"]
pub struct LCDGATE_W<'a> {
    w: &'a mut W,
}
impl<'a> LCDGATE_W<'a> {
    #[doc = r"Sets the field bit"]
...
impl R {
    ...
    #[inline(always)]
    pub fn regfreeze(&self) -> REGFREEZE_R { REGFREEZE_R::new((self.bits & 0x01) != 0) }
    #[doc = "Bit 1 - LCD Gate"]
    #[inline(always)]
    pub fn lcdgate(&self) -> LCDGATE_R { LCDGATE_R::new(((self.bits >> 1) & 0x01) != 0) }
}
impl W {
    #[doc = "Bit 0 - Register Update Freeze"]
    #[inline(always)]
    pub fn regfreeze(&mut self) -> REGFREEZE_W { REGFREEZE_W { w: self } }
    #[doc = "Bit 1 - LCD Gate"]
    #[inline(always)]
    pub fn lcdgate(&mut self) -> LCDGATE_W { LCDGATE_W { w: self } }
}
