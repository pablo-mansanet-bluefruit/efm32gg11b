...
impl R {
    ...
    #[inline(always)]
    pub fn instrdone(&self) -> INSTRDONE_R { INSTRDONE_R::new((self.bits & 0x01) != 0) }
    #[doc = "Bit 1 - SEQDONE Interrupt Enable"]
    #[inline(always)]
    pub fn seqdone(&self) -> SEQDONE_R { SEQDONE_R::new(((self.bits >> 1) & 0x01) != 0) }
}
impl W {
    #[doc = "Bit 0 - INSTRDONE Interrupt Enable"]
    #[inline(always)]
    pub fn instrdone(&mut self) -> INSTRDONE_W { INSTRDONE_W { w: self } }
    #[doc = "Bit 1 - SEQDONE Interrupt Enable"]
    #[inline(always)]
    pub fn seqdone(&mut self) -> SEQDONE_W { SEQDONE_W { w: self } }
}
