...
impl R {
    ...
    #[inline(always)]
    pub fn rdstatus(&self) -> RDSTATUS_R { RDSTATUS_R::new(((self.bits >> 2) & 0x01) != 0) }
    #[doc = "Bit 3 - SRAM Full"]
    #[inline(always)]
    pub fn sramfull(&self) -> SRAMFULL_R { SRAMFULL_R::new(((self.bits >> 3) & 0x01) != 0) }
    #[doc = "Bit 4 - Two Indirect Read Operations Have Been Queued"]
    #[inline(always)]
    pub fn rdqueued(&self) -> RDQUEUED_R { RDQUEUED_R::new(((self.bits >> 4) & 0x01) != 0) }
...
impl W {
    ...
    #[doc = "Bit 3 - SRAM Full"]
    #[inline(always)]
    pub fn sramfull(&mut self) -> SRAMFULL_W { SRAMFULL_W { w: self } }
    #[doc = "Bit 5 - Indirect Completion Status"]
    #[inline(always)]
