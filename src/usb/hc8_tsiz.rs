#[doc = "Reader of register HC8_TSIZ"]
pub type R = crate::R<u32, super::HC8_TSIZ>;
#[doc = "Writer for register HC8_TSIZ"]
pub type W = crate::W<u32, super::HC8_TSIZ>;
#[doc = "Register HC8_TSIZ `reset()`'s with value 0"]
impl crate::ResetValue for super::HC8_TSIZ {
    type Type = u32;
    #[inline(always)]
