#[doc = "Reader of register HC1_TSIZ"]
pub type R = crate::R<u32, super::HC1_TSIZ>;
#[doc = "Writer for register HC1_TSIZ"]
pub type W = crate::W<u32, super::HC1_TSIZ>;
#[doc = "Register HC1_TSIZ `reset()`'s with value 0"]
impl crate::ResetValue for super::HC1_TSIZ {
    type Type = u32;
    #[inline(always)]
