#[doc = "Reader of register HC4_TSIZ"]
pub type R = crate::R<u32, super::HC4_TSIZ>;
#[doc = "Writer for register HC4_TSIZ"]
pub type W = crate::W<u32, super::HC4_TSIZ>;
#[doc = "Register HC4_TSIZ `reset()`'s with value 0"]
impl crate::ResetValue for super::HC4_TSIZ {
    type Type = u32;
    #[inline(always)]
