#[doc = "Reader of register HC9_TSIZ"]
pub type R = crate::R<u32, super::HC9_TSIZ>;
#[doc = "Writer for register HC9_TSIZ"]
pub type W = crate::W<u32, super::HC9_TSIZ>;
#[doc = "Register HC9_TSIZ `reset()`'s with value 0"]
impl crate::ResetValue for super::HC9_TSIZ {
    type Type = u32;
    #[inline(always)]
