...
impl crate::ResetValue for super::GNPTXFSIZ {
    type Type = u32;
    #[inline(always)]
    fn reset_value() -> Self::Type { 0x0200_0200 }
}
...
impl R {
    ...
    #[inline(always)]
    pub fn nptxfstaddr(&self) -> NPTXFSTADDR_R { NPTXFSTADDR_R::new((self.bits & 0xffff) as u16) }
...
impl W {
    #[doc = "Bits 0:15 - Non-periodic Transmit RAM Start Address"]
    #[inline(always)]
    pub fn nptxfstaddr(&mut self) -> NPTXFSTADDR_W { NPTXFSTADDR_W { w: self } }
    #[doc = "Bits 16:31 - Non-periodic TxFIFO Depth (host only) / IN Endpoint TxFIFO 0 Depth (device only)"]
    #[inline(always)]
    pub fn nptxfineptxf0dep(&mut self) -> NPTXFINEPTXF0DEP_W { NPTXFINEPTXF0DEP_W { w: self } }
}
