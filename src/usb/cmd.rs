...
#[doc = "Write proxy for field `STARTCD`"]
pub struct STARTCD_W<'a> {
    w: &'a mut W,
}
impl<'a> STARTCD_W<'a> {
...
#[doc = "Write proxy for field `STOPCD`"]
pub struct STOPCD_W<'a> {
    w: &'a mut W,
}
impl<'a> STOPCD_W<'a> {
    #[doc = r"Sets the field bit"]
...
impl W {
    ...
    #[inline(always)]
    pub fn startcd(&mut self) -> STARTCD_W { STARTCD_W { w: self } }
    #[doc = "Bit 1 - Start Charger Detection in Progress"]
    #[inline(always)]
    pub fn stopcd(&mut self) -> STOPCD_W { STOPCD_W { w: self } }
}
