...
impl crate::ResetValue for super::DVBUSPULSE {
    type Type = u32;
    #[inline(always)]
    fn reset_value() -> Self::Type { 0x05b8 }
}
...
impl R {
    ...
    #[inline(always)]
    pub fn dvbuspulse(&self) -> DVBUSPULSE_R { DVBUSPULSE_R::new((self.bits & 0x0fff) as u16) }
}
impl W {
    #[doc = "Bits 0:11 - Device VBUS Pulsing Time"]
    #[inline(always)]
    pub fn dvbuspulse(&mut self) -> DVBUSPULSE_W { DVBUSPULSE_W { w: self } }
}
