#[doc = "Reader of register DOEP1_CTL"]
pub type R = crate::R<u32, super::DOEP1_CTL>;
#[doc = "Writer for register DOEP1_CTL"]
pub type W = crate::W<u32, super::DOEP1_CTL>;
#[doc = "Register DOEP1_CTL `reset()`'s with value 0"]
impl crate::ResetValue for super::DOEP1_CTL {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[inline(always)]
    pub fn snp(&self) -> SNP_R { SNP_R::new(((self.bits >> 20) & 0x01) != 0) }
...
impl W {
    ...
    #[doc = "Bit 20 - Snoop Mode"]
    #[inline(always)]
    pub fn snp(&mut self) -> SNP_W { SNP_W { w: self } }
    #[doc = "Bit 21 - STALL Handshake"]
    #[inline(always)]
