#[doc = "Reader of register HC7_TSIZ"]
pub type R = crate::R<u32, super::HC7_TSIZ>;
#[doc = "Writer for register HC7_TSIZ"]
pub type W = crate::W<u32, super::HC7_TSIZ>;
#[doc = "Register HC7_TSIZ `reset()`'s with value 0"]
impl crate::ResetValue for super::HC7_TSIZ {
    type Type = u32;
    #[inline(always)]
