...
impl crate::ResetValue for super::DVBUSDIS {
    type Type = u32;
    #[inline(always)]
    fn reset_value() -> Self::Type { 0x17d7 }
}
...
impl R {
    ...
    #[inline(always)]
    pub fn dvbusdis(&self) -> DVBUSDIS_R { DVBUSDIS_R::new((self.bits & 0xffff) as u16) }
}
impl W {
    #[doc = "Bits 0:15 - Device VBUS Discharge Time"]
    #[inline(always)]
    pub fn dvbusdis(&mut self) -> DVBUSDIS_W { DVBUSDIS_W { w: self } }
}
