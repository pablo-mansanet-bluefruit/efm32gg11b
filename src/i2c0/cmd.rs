...
#[doc = "Write proxy for field `CLEARPC`"]
...
impl W {
    ...
    #[inline(always)]
    pub fn cont(&mut self) -> CONT_W { CONT_W { w: self } }
    #[doc = "Bit 5 - Abort Transmission"]
    #[inline(always)]
    pub fn abort(&mut self) -> ABORT_W { ABORT_W { w: self } }
    #[doc = "Bit 6 - Clear TX"]
    #[inline(always)]
    pub fn cleartx(&mut self) -> CLEARTX_W { CLEARTX_W { w: self } }
    #[doc = "Bit 7 - Clear Pending Commands"]
    #[inline(always)]
    pub fn clearpc(&mut self) -> CLEARPC_W { CLEARPC_W { w: self } }
}
