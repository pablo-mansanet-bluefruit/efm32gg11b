#[doc = "Reader of register CH13_LINK"]
pub type R = crate::R<u32, super::CH13_LINK>;
#[doc = "Writer for register CH13_LINK"]
pub type W = crate::W<u32, super::CH13_LINK>;
#[doc = "Register CH13_LINK `reset()`'s with value 0"]
impl crate::ResetValue for super::CH13_LINK {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[inline(always)]
    pub fn linkmode(&self) -> LINKMODE_R { LINKMODE_R::new((self.bits & 0x01) != 0) }
    #[doc = "Bit 1 - Link Next Structure"]
    #[inline(always)]
    pub fn link(&self) -> LINK_R { LINK_R::new(((self.bits >> 1) & 0x01) != 0) }
...
impl W {
    #[doc = "Bit 1 - Link Next Structure"]
    #[inline(always)]
    pub fn link(&mut self) -> LINK_W { LINK_W { w: self } }
    #[doc = "Bits 2:31 - Link Structure Address"]
    #[inline(always)]
    pub fn linkaddr(&mut self) -> LINKADDR_W { LINKADDR_W { w: self } }
}
