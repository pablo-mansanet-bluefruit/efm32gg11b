#[doc = "Reader of register CH4_DST"]
pub type R = crate::R<u32, super::CH4_DST>;
#[doc = "Writer for register CH4_DST"]
pub type W = crate::W<u32, super::CH4_DST>;
#[doc = "Register CH4_DST `reset()`'s with value 0"]
impl crate::ResetValue for super::CH4_DST {
    type Type = u32;
    #[inline(always)]
