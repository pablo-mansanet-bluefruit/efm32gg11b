#[doc = "Reader of register CH16_SRC"]
pub type R = crate::R<u32, super::CH16_SRC>;
#[doc = "Writer for register CH16_SRC"]
pub type W = crate::W<u32, super::CH16_SRC>;
#[doc = "Register CH16_SRC `reset()`'s with value 0"]
impl crate::ResetValue for super::CH16_SRC {
    type Type = u32;
    #[inline(always)]
