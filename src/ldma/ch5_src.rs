#[doc = "Reader of register CH5_SRC"]
pub type R = crate::R<u32, super::CH5_SRC>;
#[doc = "Writer for register CH5_SRC"]
pub type W = crate::W<u32, super::CH5_SRC>;
#[doc = "Register CH5_SRC `reset()`'s with value 0"]
impl crate::ResetValue for super::CH5_SRC {
    type Type = u32;
    #[inline(always)]
