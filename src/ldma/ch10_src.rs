#[doc = "Reader of register CH10_SRC"]
pub type R = crate::R<u32, super::CH10_SRC>;
#[doc = "Writer for register CH10_SRC"]
pub type W = crate::W<u32, super::CH10_SRC>;
#[doc = "Register CH10_SRC `reset()`'s with value 0"]
impl crate::ResetValue for super::CH10_SRC {
    type Type = u32;
    #[inline(always)]
