#[doc = "Reader of register CH13_SRC"]
pub type R = crate::R<u32, super::CH13_SRC>;
#[doc = "Writer for register CH13_SRC"]
pub type W = crate::W<u32, super::CH13_SRC>;
#[doc = "Register CH13_SRC `reset()`'s with value 0"]
impl crate::ResetValue for super::CH13_SRC {
    type Type = u32;
    #[inline(always)]
