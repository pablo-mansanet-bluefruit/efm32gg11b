#[doc = "Reader of register CH18_SRC"]
pub type R = crate::R<u32, super::CH18_SRC>;
#[doc = "Writer for register CH18_SRC"]
pub type W = crate::W<u32, super::CH18_SRC>;
#[doc = "Register CH18_SRC `reset()`'s with value 0"]
impl crate::ResetValue for super::CH18_SRC {
    type Type = u32;
    #[inline(always)]
