#[doc = "Reader of register CH7_DST"]
pub type R = crate::R<u32, super::CH7_DST>;
#[doc = "Writer for register CH7_DST"]
pub type W = crate::W<u32, super::CH7_DST>;
#[doc = "Register CH7_DST `reset()`'s with value 0"]
impl crate::ResetValue for super::CH7_DST {
    type Type = u32;
    #[inline(always)]
