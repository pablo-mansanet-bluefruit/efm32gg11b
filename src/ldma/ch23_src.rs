#[doc = "Reader of register CH23_SRC"]
pub type R = crate::R<u32, super::CH23_SRC>;
#[doc = "Writer for register CH23_SRC"]
pub type W = crate::W<u32, super::CH23_SRC>;
#[doc = "Register CH23_SRC `reset()`'s with value 0"]
impl crate::ResetValue for super::CH23_SRC {
    type Type = u32;
    #[inline(always)]
