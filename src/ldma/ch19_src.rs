#[doc = "Reader of register CH19_SRC"]
pub type R = crate::R<u32, super::CH19_SRC>;
#[doc = "Writer for register CH19_SRC"]
pub type W = crate::W<u32, super::CH19_SRC>;
#[doc = "Register CH19_SRC `reset()`'s with value 0"]
impl crate::ResetValue for super::CH19_SRC {
    type Type = u32;
    #[inline(always)]
