#[doc = "Reader of register CH12_SRC"]
pub type R = crate::R<u32, super::CH12_SRC>;
#[doc = "Writer for register CH12_SRC"]
pub type W = crate::W<u32, super::CH12_SRC>;
#[doc = "Register CH12_SRC `reset()`'s with value 0"]
impl crate::ResetValue for super::CH12_SRC {
    type Type = u32;
    #[inline(always)]
