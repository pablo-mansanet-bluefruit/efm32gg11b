#[doc = "Reader of register CH4_SRC"]
pub type R = crate::R<u32, super::CH4_SRC>;
#[doc = "Writer for register CH4_SRC"]
pub type W = crate::W<u32, super::CH4_SRC>;
#[doc = "Register CH4_SRC `reset()`'s with value 0"]
impl crate::ResetValue for super::CH4_SRC {
    type Type = u32;
    #[inline(always)]
