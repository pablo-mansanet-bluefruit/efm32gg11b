#[doc = "Reader of register CH14_SRC"]
pub type R = crate::R<u32, super::CH14_SRC>;
#[doc = "Writer for register CH14_SRC"]
pub type W = crate::W<u32, super::CH14_SRC>;
#[doc = "Register CH14_SRC `reset()`'s with value 0"]
impl crate::ResetValue for super::CH14_SRC {
    type Type = u32;
    #[inline(always)]
