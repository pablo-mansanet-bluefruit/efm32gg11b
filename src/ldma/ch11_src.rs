#[doc = "Reader of register CH11_SRC"]
pub type R = crate::R<u32, super::CH11_SRC>;
#[doc = "Writer for register CH11_SRC"]
pub type W = crate::W<u32, super::CH11_SRC>;
#[doc = "Register CH11_SRC `reset()`'s with value 0"]
impl crate::ResetValue for super::CH11_SRC {
    type Type = u32;
    #[inline(always)]
