#[doc = "Reader of register CH2_DST"]
pub type R = crate::R<u32, super::CH2_DST>;
#[doc = "Writer for register CH2_DST"]
pub type W = crate::W<u32, super::CH2_DST>;
#[doc = "Register CH2_DST `reset()`'s with value 0"]
impl crate::ResetValue for super::CH2_DST {
    type Type = u32;
    #[inline(always)]
