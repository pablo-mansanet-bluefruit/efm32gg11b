#[doc = "Reader of register CH7_SRC"]
pub type R = crate::R<u32, super::CH7_SRC>;
#[doc = "Writer for register CH7_SRC"]
pub type W = crate::W<u32, super::CH7_SRC>;
#[doc = "Register CH7_SRC `reset()`'s with value 0"]
impl crate::ResetValue for super::CH7_SRC {
    type Type = u32;
    #[inline(always)]
