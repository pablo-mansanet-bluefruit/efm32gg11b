#[doc = "Reader of register CH12_DST"]
pub type R = crate::R<u32, super::CH12_DST>;
#[doc = "Writer for register CH12_DST"]
pub type W = crate::W<u32, super::CH12_DST>;
#[doc = "Register CH12_DST `reset()`'s with value 0"]
impl crate::ResetValue for super::CH12_DST {
    type Type = u32;
    #[inline(always)]
