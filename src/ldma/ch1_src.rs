#[doc = "Reader of register CH1_SRC"]
pub type R = crate::R<u32, super::CH1_SRC>;
#[doc = "Writer for register CH1_SRC"]
pub type W = crate::W<u32, super::CH1_SRC>;
#[doc = "Register CH1_SRC `reset()`'s with value 0"]
impl crate::ResetValue for super::CH1_SRC {
    type Type = u32;
    #[inline(always)]
