#[doc = "Reader of register CH20_DST"]
pub type R = crate::R<u32, super::CH20_DST>;
#[doc = "Writer for register CH20_DST"]
pub type W = crate::W<u32, super::CH20_DST>;
#[doc = "Register CH20_DST `reset()`'s with value 0"]
impl crate::ResetValue for super::CH20_DST {
    type Type = u32;
    #[inline(always)]
