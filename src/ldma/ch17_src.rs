#[doc = "Reader of register CH17_SRC"]
pub type R = crate::R<u32, super::CH17_SRC>;
#[doc = "Writer for register CH17_SRC"]
pub type W = crate::W<u32, super::CH17_SRC>;
#[doc = "Register CH17_SRC `reset()`'s with value 0"]
impl crate::ResetValue for super::CH17_SRC {
    type Type = u32;
    #[inline(always)]
