#[doc = "Reader of register CH15_SRC"]
pub type R = crate::R<u32, super::CH15_SRC>;
#[doc = "Writer for register CH15_SRC"]
pub type W = crate::W<u32, super::CH15_SRC>;
#[doc = "Register CH15_SRC `reset()`'s with value 0"]
impl crate::ResetValue for super::CH15_SRC {
    type Type = u32;
    #[inline(always)]
