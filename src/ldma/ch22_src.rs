#[doc = "Reader of register CH22_SRC"]
pub type R = crate::R<u32, super::CH22_SRC>;
#[doc = "Writer for register CH22_SRC"]
pub type W = crate::W<u32, super::CH22_SRC>;
#[doc = "Register CH22_SRC `reset()`'s with value 0"]
impl crate::ResetValue for super::CH22_SRC {
    type Type = u32;
    #[inline(always)]
