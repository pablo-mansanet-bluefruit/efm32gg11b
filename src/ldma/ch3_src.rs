#[doc = "Reader of register CH3_SRC"]
pub type R = crate::R<u32, super::CH3_SRC>;
#[doc = "Writer for register CH3_SRC"]
pub type W = crate::W<u32, super::CH3_SRC>;
#[doc = "Register CH3_SRC `reset()`'s with value 0"]
impl crate::ResetValue for super::CH3_SRC {
    type Type = u32;
    #[inline(always)]
