#[doc = "Reader of register CH2_SRC"]
pub type R = crate::R<u32, super::CH2_SRC>;
#[doc = "Writer for register CH2_SRC"]
pub type W = crate::W<u32, super::CH2_SRC>;
#[doc = "Register CH2_SRC `reset()`'s with value 0"]
impl crate::ResetValue for super::CH2_SRC {
    type Type = u32;
    #[inline(always)]
