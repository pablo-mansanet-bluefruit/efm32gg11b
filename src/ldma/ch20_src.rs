#[doc = "Reader of register CH20_SRC"]
pub type R = crate::R<u32, super::CH20_SRC>;
#[doc = "Writer for register CH20_SRC"]
pub type W = crate::W<u32, super::CH20_SRC>;
#[doc = "Register CH20_SRC `reset()`'s with value 0"]
impl crate::ResetValue for super::CH20_SRC {
    type Type = u32;
    #[inline(always)]
