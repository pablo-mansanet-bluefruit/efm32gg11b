#[doc = "Reader of register CH20_REQSEL"]
pub type R = crate::R<u32, super::CH20_REQSEL>;
#[doc = "Writer for register CH20_REQSEL"]
pub type W = crate::W<u32, super::CH20_REQSEL>;
#[doc = "Register CH20_REQSEL `reset()`'s with value 0"]
impl crate::ResetValue for super::CH20_REQSEL {
    type Type = u32;
    #[inline(always)]
