#[doc = "Reader of register CH1_DST"]
pub type R = crate::R<u32, super::CH1_DST>;
#[doc = "Writer for register CH1_DST"]
pub type W = crate::W<u32, super::CH1_DST>;
#[doc = "Register CH1_DST `reset()`'s with value 0"]
impl crate::ResetValue for super::CH1_DST {
    type Type = u32;
    #[inline(always)]
