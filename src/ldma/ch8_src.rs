#[doc = "Reader of register CH8_SRC"]
pub type R = crate::R<u32, super::CH8_SRC>;
#[doc = "Writer for register CH8_SRC"]
pub type W = crate::W<u32, super::CH8_SRC>;
#[doc = "Register CH8_SRC `reset()`'s with value 0"]
impl crate::ResetValue for super::CH8_SRC {
    type Type = u32;
    #[inline(always)]
