#[doc = "Reader of register CH0_SRC"]
pub type R = crate::R<u32, super::CH0_SRC>;
#[doc = "Writer for register CH0_SRC"]
pub type W = crate::W<u32, super::CH0_SRC>;
#[doc = "Register CH0_SRC `reset()`'s with value 0"]
impl crate::ResetValue for super::CH0_SRC {
    type Type = u32;
    #[inline(always)]
