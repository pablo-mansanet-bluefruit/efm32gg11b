#[doc = "Reader of register CH21_SRC"]
pub type R = crate::R<u32, super::CH21_SRC>;
#[doc = "Writer for register CH21_SRC"]
pub type W = crate::W<u32, super::CH21_SRC>;
#[doc = "Register CH21_SRC `reset()`'s with value 0"]
impl crate::ResetValue for super::CH21_SRC {
    type Type = u32;
    #[inline(always)]
