...
impl R {
    ...
    #[inline(always)]
    pub fn dec(&self) -> DEC_R { DEC_R::new(((self.bits >> 17) & 0x01) != 0) }
    #[doc = "Bit 18 - DECERR Interrupt Enable"]
    #[inline(always)]
    pub fn decerr(&self) -> DECERR_R { DECERR_R::new(((self.bits >> 18) & 0x01) != 0) }
    #[doc = "Bit 19 - BUFDATAV Interrupt Enable"]
    #[inline(always)]
    pub fn bufdatav(&self) -> BUFDATAV_R { BUFDATAV_R::new(((self.bits >> 19) & 0x01) != 0) }
    #[doc = "Bit 20 - BUFLEVEL Interrupt Enable"]
    #[inline(always)]
    pub fn buflevel(&self) -> BUFLEVEL_R { BUFLEVEL_R::new(((self.bits >> 20) & 0x01) != 0) }
    #[doc = "Bit 21 - BUFOF Interrupt Enable"]
    #[inline(always)]
    pub fn bufof(&self) -> BUFOF_R { BUFOF_R::new(((self.bits >> 21) & 0x01) != 0) }
    #[doc = "Bit 22 - CNTOF Interrupt Enable"]
    #[inline(always)]
    pub fn cntof(&self) -> CNTOF_R { CNTOF_R::new(((self.bits >> 22) & 0x01) != 0) }
}
impl W {
    #[doc = "Bit 0 - CH0 Interrupt Enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 16 - SCANCOMPLETE Interrupt Enable"]
    #[inline(always)]
    pub fn scancomplete(&mut self) -> SCANCOMPLETE_W { SCANCOMPLETE_W { w: self } }
    #[doc = "Bit 17 - DEC Interrupt Enable"]
    #[inline(always)]
    pub fn dec(&mut self) -> DEC_W { DEC_W { w: self } }
    #[doc = "Bit 18 - DECERR Interrupt Enable"]
    #[inline(always)]
    pub fn decerr(&mut self) -> DECERR_W { DECERR_W { w: self } }
    #[doc = "Bit 19 - BUFDATAV Interrupt Enable"]
    #[inline(always)]
    pub fn bufdatav(&mut self) -> BUFDATAV_W { BUFDATAV_W { w: self } }
    #[doc = "Bit 20 - BUFLEVEL Interrupt Enable"]
    #[inline(always)]
    pub fn buflevel(&mut self) -> BUFLEVEL_W { BUFLEVEL_W { w: self } }
    #[doc = "Bit 21 - BUFOF Interrupt Enable"]
    #[inline(always)]
    pub fn bufof(&mut self) -> BUFOF_W { BUFOF_W { w: self } }
    #[doc = "Bit 22 - CNTOF Interrupt Enable"]
    #[inline(always)]
    pub fn cntof(&mut self) -> CNTOF_W { CNTOF_W { w: self } }
}
