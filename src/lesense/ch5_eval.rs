#[doc = "Reader of register CH5_EVAL"]
pub type R = crate::R<u32, super::CH5_EVAL>;
#[doc = "Writer for register CH5_EVAL"]
pub type W = crate::W<u32, super::CH5_EVAL>;
#[doc = "Register CH5_EVAL `reset()`'s with value 0"]
impl crate::ResetValue for super::CH5_EVAL {
    type Type = u32;
    #[inline(always)]
