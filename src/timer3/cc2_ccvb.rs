#[doc = "Reader of register CC2_CCVB"]
pub type R = crate::R<u32, super::CC2_CCVB>;
#[doc = "Writer for register CC2_CCVB"]
pub type W = crate::W<u32, super::CC2_CCVB>;
#[doc = "Register CC2_CCVB `reset()`'s with value 0"]
impl crate::ResetValue for super::CC2_CCVB {
    type Type = u32;
    #[inline(always)]
