#[doc = "Reader of register OPA2_CTRL"]
pub type R = crate::R<u32, super::OPA2_CTRL>;
#[doc = "Writer for register OPA2_CTRL"]
pub type W = crate::W<u32, super::OPA2_CTRL>;
#[doc = "Register OPA2_CTRL `reset()`'s with value 0x0e"]
impl crate::ResetValue for super::OPA2_CTRL {
    type Type = u32;
    #[inline(always)]
