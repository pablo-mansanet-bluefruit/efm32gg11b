#[doc = "Reader of register OPA2_OUT"]
pub type R = crate::R<u32, super::OPA2_OUT>;
#[doc = "Writer for register OPA2_OUT"]
pub type W = crate::W<u32, super::OPA2_OUT>;
#[doc = "Register OPA2_OUT `reset()`'s with value 0x01"]
impl crate::ResetValue for super::OPA2_OUT {
    type Type = u32;
    #[inline(always)]
