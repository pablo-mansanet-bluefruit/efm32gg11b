...
impl W {
    ...
    #[inline(always)]
    pub fn ch0en(&mut self) -> CH0EN_W { CH0EN_W { w: self } }
    #[doc = "Bit 1 - DAC Channel 0 Disable"]
    #[inline(always)]
    pub fn ch0dis(&mut self) -> CH0DIS_W { CH0DIS_W { w: self } }
    #[doc = "Bit 2 - DAC Channel 1 Enable"]
    #[inline(always)]
    pub fn ch1en(&mut self) -> CH1EN_W { CH1EN_W { w: self } }
    #[doc = "Bit 3 - DAC Channel 1 Disable"]
    #[inline(always)]
    pub fn ch1dis(&mut self) -> CH1DIS_W { CH1DIS_W { w: self } }
    #[doc = "Bit 16 - OPA0 Enable"]
    #[inline(always)]
    pub fn opa0en(&mut self) -> OPA0EN_W { OPA0EN_W { w: self } }
    #[doc = "Bit 17 - OPA0 Disable"]
    #[inline(always)]
    pub fn opa0dis(&mut self) -> OPA0DIS_W { OPA0DIS_W { w: self } }
    #[doc = "Bit 18 - OPA1 Enable"]
    #[inline(always)]
    pub fn opa1en(&mut self) -> OPA1EN_W { OPA1EN_W { w: self } }
    #[doc = "Bit 19 - OPA1 Disable"]
    #[inline(always)]
    pub fn opa1dis(&mut self) -> OPA1DIS_W { OPA1DIS_W { w: self } }
    #[doc = "Bit 20 - OPA2 Enable"]
    #[inline(always)]
    pub fn opa2en(&mut self) -> OPA2EN_W { OPA2EN_W { w: self } }
    #[doc = "Bit 21 - OPA2 Disable"]
    #[inline(always)]
    pub fn opa2dis(&mut self) -> OPA2DIS_W { OPA2DIS_W { w: self } }
    #[doc = "Bit 22 - OPA3 Enable"]
    #[inline(always)]
    pub fn opa3en(&mut self) -> OPA3EN_W { OPA3EN_W { w: self } }
    #[doc = "Bit 23 - OPA3 Disable"]
    #[inline(always)]
    pub fn opa3dis(&mut self) -> OPA3DIS_W { OPA3DIS_W { w: self } }
}
