#[doc = "Reader of register BITTIMING"]
pub type R = crate::R<u32, super::BITTIMING>;
#[doc = "Writer for register BITTIMING"]
pub type W = crate::W<u32, super::BITTIMING>;
#[doc = "Register BITTIMING `reset()`'s with value 0x2301"]
impl crate::ResetValue for super::BITTIMING {
    type Type = u32;
    #[inline(always)]
    fn reset_value() -> Self::Type { 0x2301 }
}
...
impl R {
    ...
    #[inline(always)]
    pub fn sjw(&self) -> SJW_R { SJW_R::new(((self.bits >> 6) & 0x03) as u8) }
    ...
    #[inline(always)]
    pub fn tseg2(&self) -> TSEG2_R { TSEG2_R::new(((self.bits >> 12) & 0x07) as u8) }
}
impl W {
    #[doc = "Bits 0:5 - Baud Rate Prescaler"]
    #[inline(always)]
    ...
    #[doc = "Bits 8:11 - Time Segment Before the Sample Point"]
    #[inline(always)]
    pub fn tseg1(&mut self) -> TSEG1_W { TSEG1_W { w: self } }
    #[doc = "Bits 12:14 - Time Segment After the Sample Point"]
    #[inline(always)]
    pub fn tseg2(&mut self) -> TSEG2_W { TSEG2_W { w: self } }
}
