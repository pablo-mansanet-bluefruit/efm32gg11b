...
impl R {
    ...
    #[inline(always)]
    pub fn init(&self) -> INIT_R { INIT_R::new((self.bits & 0x01) != 0) }
    #[doc = "Bit 1 - Module Interrupt Enable"]
    #[inline(always)]
    pub fn ie(&self) -> IE_R { IE_R::new(((self.bits >> 1) & 0x01) != 0) }
    #[doc = "Bit 2 - Status Change Interrupt Enable"]
    #[inline(always)]
    pub fn sie(&self) -> SIE_R { SIE_R::new(((self.bits >> 2) & 0x01) != 0) }
    #[doc = "Bit 3 - Error Interrupt Enable"]
    #[inline(always)]
    pub fn eie(&self) -> EIE_R { EIE_R::new(((self.bits >> 3) & 0x01) != 0) }
    #[doc = "Bit 5 - Disable Automatic Retransmission"]
    #[inline(always)]
    pub fn dar(&self) -> DAR_R { DAR_R::new(((self.bits >> 5) & 0x01) != 0) }
    #[doc = "Bit 6 - Configuration Change Enable"]
    #[inline(always)]
    pub fn cce(&self) -> CCE_R { CCE_R::new(((self.bits >> 6) & 0x01) != 0) }
    #[doc = "Bit 7 - Test Mode Enable Write"]
    #[inline(always)]
    pub fn test(&self) -> TEST_R { TEST_R::new(((self.bits >> 7) & 0x01) != 0) }
}
impl W {
    #[doc = "Bit 0 - Initialize"]
    #[inline(always)]
    pub fn init(&mut self) -> INIT_W { INIT_W { w: self } }
    #[doc = "Bit 1 - Module Interrupt Enable"]
    #[inline(always)]
    pub fn ie(&mut self) -> IE_W { IE_W { w: self } }
    #[doc = "Bit 2 - Status Change Interrupt Enable"]
    #[inline(always)]
    pub fn sie(&mut self) -> SIE_W { SIE_W { w: self } }
    #[doc = "Bit 3 - Error Interrupt Enable"]
    #[inline(always)]
    pub fn eie(&mut self) -> EIE_W { EIE_W { w: self } }
    #[doc = "Bit 5 - Disable Automatic Retransmission"]
    #[inline(always)]
    pub fn dar(&mut self) -> DAR_W { DAR_W { w: self } }
    #[doc = "Bit 6 - Configuration Change Enable"]
    #[inline(always)]
    pub fn cce(&mut self) -> CCE_W { CCE_W { w: self } }
    #[doc = "Bit 7 - Test Mode Enable Write"]
    #[inline(always)]
    pub fn test(&mut self) -> TEST_W { TEST_W { w: self } }
}
