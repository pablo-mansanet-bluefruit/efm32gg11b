#[doc = "Reader of register SPECTYPE4"]
pub type R = crate::R<u32, super::SPECTYPE4>;
#[doc = "Writer for register SPECTYPE4"]
pub type W = crate::W<u32, super::SPECTYPE4>;
#[doc = "Register SPECTYPE4 `reset()`'s with value 0"]
impl crate::ResetValue for super::SPECTYPE4 {
    type Type = u32;
    #[inline(always)]
