#[doc = "Reader of register SPECADDR2TOP"]
pub type R = crate::R<u32, super::SPECADDR2TOP>;
#[doc = "Writer for register SPECADDR2TOP"]
pub type W = crate::W<u32, super::SPECADDR2TOP>;
#[doc = "Register SPECADDR2TOP `reset()`'s with value 0"]
impl crate::ResetValue for super::SPECADDR2TOP {
    type Type = u32;
    #[inline(always)]
