#[doc = "Reader of register SPECTYPE2"]
pub type R = crate::R<u32, super::SPECTYPE2>;
#[doc = "Writer for register SPECTYPE2"]
pub type W = crate::W<u32, super::SPECTYPE2>;
#[doc = "Register SPECTYPE2 `reset()`'s with value 0"]
impl crate::ResetValue for super::SPECTYPE2 {
    type Type = u32;
    #[inline(always)]
