#[doc = "Reader of register SPECTYPE3"]
pub type R = crate::R<u32, super::SPECTYPE3>;
#[doc = "Writer for register SPECTYPE3"]
pub type W = crate::W<u32, super::SPECTYPE3>;
#[doc = "Register SPECTYPE3 `reset()`'s with value 0"]
impl crate::ResetValue for super::SPECTYPE3 {
    type Type = u32;
    #[inline(always)]
